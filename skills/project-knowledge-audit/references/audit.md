...
- `category`、`derivation`、`pk_source_type`、`generated`、`verified`の不整合や、不要なlegacy extension
...
形式0.1と0.2をread-onlyで扱い、0.1の分類欠落はmigration後の補完候補として報告する。未対応形式では監査を続けず、対応Skillの更新が必要と報告する。
