...
`state.yml`のschema版は`state_schema_version`で管理する。Knowledge形式版、Skill版、OKF版とは連動させない。stateの正本境界、最小schema、復旧規則は[state.md](state.md)を参照する。
